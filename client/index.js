...
export function renderGame(initialRoomObj, playerName) {
  ...
  console.log('gameState currentPlayers', gameState.currentPlayers)
  console.log('gs iro', initialRoomObj.currentPlayers)

  //renderUnits(defaultUnits)
  GameContainer.addChild(BoardContainer)
}
export function takeTurn(updatedRoomObj) {
  //Global gameState stored locally
  //socket object is owner of currentPlayers
  gameState.currentPlayers = updatedRoomObj.currentPlayers
